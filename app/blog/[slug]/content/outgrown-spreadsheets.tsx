export function OutgrownSpreadsheetsContent() {
  return (
    <>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">1. The &quot;Please Don&apos;t Touch That File&quot; Syndrome</h2>

      <p>
        You know the file I&apos;m talking about. The one with the cryptic name like <code>Final_Budget_v7_ACTUALLY_FINAL_Nov23_JA_edits.xlsx</code>. The one that only Jennifer knows how to update. The one that breaks if you look at it wrong.
      </p>

      <p>
        <strong>Why it matters:</strong> When a single person is the bottleneck for critical financial data, you don&apos;t have a system—you have a single point of failure. What happens when Jennifer goes on vacation? Or worse, leaves the company?
      </p>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">2. Your Monthly Close Takes Longer Than a Week</h2>
      ...
      <p>
        <strong>The hidden cost:</strong> Every day you spend closing last month is a day you&apos;re not analyzing next quarter. You&apos;re driving by looking in the rearview mirror.
      </p>

      <h2 className="text-3xl font-bold mt-12 mb-6">3. You&apos;re Consolidating Data from 3+ Sources Manually</h2>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">4. The Same Questions Keep Interrupting Your Day</h2>

      <p>
        &quot;What&apos;s our cash position?&quot;<br />
        &quot;How are we tracking against budget?&quot;<br />
        &quot;What&apos;s our runway?&quot;
      </p>
      ...
      <div className="bg-orange-500/10 border border-orange-500/30 p-6 my-8 rounded-lg">
        <p className="font-semibold text-orange-400 mb-2">Pro Tip:</p>
        <p className="text-slate-300">
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">5. You Can&apos;t Answer &quot;Why?&quot; Questions</h2>

      <p>
        Spreadsheets are great at showing you <em>what</em> happened. Revenue was down 12% last month. Expenses were up 8%. Okay, great. But <em>why?</em>
      </p>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">6. Your Team Spends More Time Formatting Than Analyzing</h2>
      ...
      <p>
        <strong>Calculate the opportunity cost:</strong> Take your average analyst salary, multiply by 0.6, and that&apos;s how much you&apos;re spending annually on work that could be automated. For a $70K analyst, that&apos;s $42K/year spent on data janitorial work.
      </p>

      <h2 className="text-3xl font-bold mt-12 mb-6">7. You&apos;ve Had the &quot;Version Control&quot; Problem More Than Once</h2>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">8. Errors Keep Appearing Despite Triple-Checking</h2>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">9. Your Spreadsheets Have Spreadsheets</h2>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">10. You&apos;re Scaling (or Planning To)</h2>
      ...
      <div className="bg-slate-800 border-l-4 border-orange-500 p-6 my-8">
        <p className="font-semibold mb-2">Case Study: Summit Education</p>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">The ROI Math That Matters</h2>
      ...
      <ul className="space-y-3">
        <li><strong>Hours saved:</strong> 40 hours/month (conservative estimate)</li>
        <li><strong>Hourly rate:</strong> $50/hour (loaded cost)</li>
        <li><strong>Monthly savings:</strong> $2,000</li>
      ...
      <ul className="space-y-2">
        ...
        <li>Better strategic analysis (because your team has time for it)</li>
        <li>Reduced turnover (because manual data work is soul-crushing)</li>
        <li>Scalability (the system that works at $10M works at $50M)</li>
      </ul>
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">What to Do Next</h2>
      ...
      <p>
        <strong>Three paths forward:</strong>
      </p>

      <div className="grid md:grid-cols-3 gap-6 my-8">
        <div className="bg-slate-800 p-6 rounded-lg">
          <h3 className="text-xl font-bold mb-3 text-orange-500">Power BI</h3>
          ...
          <p className="text-slate-400 text-sm">
            ...
            <strong>Cost:</strong> $7,500-$15,000
          </p>
        </div>
        <div className="bg-slate-800 p-6 rounded-lg">
          <h3 className="text-xl font-bold mb-3 text-orange-500">Custom Application</h3>
          <p className="text-slate-300 text-sm mb-4">
            Best for: Unique workflows, complex business logic, or processes that don&apos;t fit standard BI tools.
          </p>
          <p className="text-slate-400 text-sm">
            <strong>Timeline:</strong> 6-12 weeks<br />
            <strong>Cost:</strong> $15,000-$30,000
          </p>
        </div>
        <div className="bg-slate-800 p-6 rounded-lg">
          <h3 className="text-xl font-bold mb-3 text-orange-500">Hybrid Approach</h3>
          <p className="text-slate-300 text-sm mb-4">
            Best for: Organizations that need both standard dashboards and custom automation for specific workflows.
          </p>
          <p className="text-slate-400 text-sm">
            <strong>Timeline:</strong> 8-14 weeks<br />
            <strong>Cost:</strong> $20,000-$40,000
          </p>
        </div>
      </div>
